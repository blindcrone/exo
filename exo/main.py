...
from exo.topology.throughput_spillover_partitioning_strategy import ThroughputSpilloverPartitioningStrategy
...
parser.add_argument("--partitioning-strategy", type=str, default="ThroughputSpillover", help="Strategy for dividing up the model")
...
partitioning_strategy=RingMemoryWeightedPartitioningStrategy() if args.partitioning_strategy == "RingMemory" else ThroughputSpilloverPartitioningStrategy()
