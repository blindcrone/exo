...
class Node(ABC):
  ...
  @abstractmethod
  async def process_prompt(self, shard: Shard, prompt: str, image_str: Optional[str] = None, request_id: Optional[str] = None, inference_state: Optional[str] = None, target: Optional[str] = None) -> Optional[np.ndarray]:
    pass
